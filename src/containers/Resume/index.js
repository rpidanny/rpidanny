                    ...
                    <div className='col-md-6'>
                      <div className='work-item'>
                        ...
                        <div className='work-desc'>
                          ...
                          <h6>2009-20011</h6>
                          <p>
                              Studied science and choose Computer Science as an
                              elective subject.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-md-6'>
                      <div className='work-item'>
                        ...
                        <div className='work-desc'>
                          ...
                          <h6>2009</h6>
                          <p>
                              This is where i learnt basic Networking and Web
                              designing
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='col-md-6'>
                      <div className='work-item'>
                        ...
                        <div className='work-desc'>
                          <h4>Gyanodaya Bal Batika, Lalitpur, Nepal</h4>
                          <h6>2006-2008</h6>
                          <p>I studied here till 10.</p>
                        </div>
                      </div>
                    </div>
                    {/* End edu */}
